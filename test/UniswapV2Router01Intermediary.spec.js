...
describe("UniswapV2Router01Intermediary", function () {
  ...
  it("Test path length modifier", async () => {
    ...
    ).to.be.revertedWith("UniswapV2Router01Intermediary: path < 2");
  ...
  it("Setting fee BP should work, but not when it is being set > 1 %", async () => {
    ...
    ).to.be.revertedWith("UniswapV2Router01Intermediary: feeBP > MAX_FEE_BP");
  });
